...
#Date: 6/6/2019
#Version: 1.14 +
#Description: Runs all the Creeping's main functions
#################################################################################################
...
execute as @s run function cpp:mobs/jungle_creeper/animate
effect give @s slowness 1 1 true

tag @s remove fuse
execute as @s[scores={CPP_time=40}] run effect give @s minecraft:resistance 10 100 true
execute at @s[scores={CPP_time=40}] run summon creeper ~ ~ ~ {ignited:1,Fuse:0,ActiveEffects:[{Id:19b,Amplifier:1b,Duration:120}]}
execute at @s[scores={CPP_time=40}] run tp @s ~ ~-600 ~
