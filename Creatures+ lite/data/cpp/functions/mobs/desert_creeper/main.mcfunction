...
#Date: 6/6/2019
#Version: 1.14 +
#Description: Runs all the Scorched Creeper's main functions
#################################################################################################
...
execute as @s run function cpp:mobs/desert_creeper/animate
effect give @s slowness 1 1 true

tag @s remove fuse
execute as @s[scores={CPP_time=10}] run effect give @s minecraft:resistance 10 100 true
execute at @s[scores={CPP_time=10}] run summon creeper ~ ~ ~ {ignited:1,Fuse:0}
execute at @s[scores={CPP_time=10}] run tp @s ~ ~-100 ~
